...
const startFunction = async () => {
    ...
    if (answere.operator === "Add") {
        console.log(chalk.green(`${answere.num1} + ${answere.num2} = ${answere.num1 + answere.num2}`));
    }
    else if (answere.operator === "Subract") {
        console.log(chalk.red(`${answere.num1} - ${answere.num2} = ${answere.num1 - answere.num2}`));
    }
    else if (answere.operator === "Multiply") {
        console.log(chalk.yellow(`${answere.num1} x ${answere.num2} = ${answere.num1 * answere.num2}`));
    }
    else if (answere.operator === "Divide") {
        console.log(chalk.bgGreenBright(`${answere.num1} / ${answere.num2} = ${answere.num1 / answere.num2}`));
    }
    else {
        console.log("ERROR");
    }
